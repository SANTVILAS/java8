...
public class SortEmployee {
	...
	public static void main(String[] args) {
		List<Employee> list = Arrays.asList(new Employee("vilas", 25, 1000), new Employee("sant", 24, 2000),
				new Employee("keshari", 27, 3000), new Employee("gupta", 26, 5000), new Employee("monu", 22, 8000));

		List<Employee> sortByName=list.stream().sorted((e1,e2)->e1.getName().compareTo(e2.getName())).collect(Collectors.toList());
	  ...
	  System.out.println("Sorting age wise");
